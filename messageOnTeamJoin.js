function messageOnTeamJoin({ slackUid }) {
  const text = `:wave: Welcome <@${slackUid}> to *${process.env.HACKATHON_NAME}* hackathon! Please choose below :point_down: how are you planning to participate. Or even choose both!`;
